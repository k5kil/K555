...
chsource = Redis:get(Fast..'chsource') or "k5kil"
...
return send(msg.chat_id, msg.id,"الرابط خطأ \nارسل الرابط بالشكل ده كمثال : https://t.me/k5kil ", 'md', true)
end
...
{
{text = '‹ ٰ𖣂 • ᑕᕼ • 𖣂 ›', url = "https://t.me/k5kil"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
{{text = '- ✦ َ𝙍َِ𝙕َِ• 𝙎َِ𝙊َِ𝙐َِ𝙍َِ𝘾َِ𝙀ِ ✦ •', url = "https://t.me/k5kil"}},
}
}
...
keyboard.inline_keyboard = {
{
{text = 'قناة السورس',url="t.me/k5kil"}
},
}
local msg_id = msg.id/2097152/0.5
...
keyboardd.inline_keyboard = {
{
{text = 'قناة السورس', url = "https://t.me/k5kil"}
},
}
local msg_id = msg.id/2097152/0.5
...
bot.sendAudio(msg_chat_id,msg_id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@k5kil")
sleep(1)
...
data = {
{
{text = 'احمد', url = "https://t.me/k5kil"}
},
{
{text = 'Ahmed', url = "https://t.me/k5kil"}
},
}
}
...
send(msg_chat_id,msg_id, "• الاصدار : 1.0","md",true)
end
...
if text == 'احمد' or text == 'مبرمج السورس' or text == 'Barlo' then  
local UserId_Info = bot.searchPublicChat("k5kil")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ احمد ❳\n— — — — — — — — —\n ⌔︙*َالاسم* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n⌔︙*بايو* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '◈ احمد ◈', url = "https://t.me/k5kil"}
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج احمد ❳', url = "https://t.me/K5KIL"}
},
{
{text = 'AHMED', url = "https://t.me/K5KIL"},
},
...
data = {
{
{text = '◜ Ahmed◞', url = 'http://t.me/'..chsource..''}, {text = '◜ AHMED◞', url = 't.me/'..devsource}, 
},
{
...
data = {
{
{text = '𓆩 ˹ [Dv] ˼ 𓆪', url = "https://t.me/k5kil"}
},
}
}
bot.sendPhoto(msg.chat_id, msg.id, 'http://t.me/'..chsource..'', [[
[ٓ ˚₊· ͟͟͞͞➳❥❬ 𝚆𝙴𝙻𝙲𝙾𝙼𝙴 𝚃𝙾 ❭• °](t.me/k5kil )
]],"md", true, nil, nil, nil, nil, nil, nil, nil, nil, reply_markup)
end
if text == '/start' then
